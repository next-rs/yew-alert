#![doc(
    html_logo_url = "https://github.com/next-rs/yew-alert/assets/62179149/b4b97406-f4a5-4235-a255-b0ffec31a05b",
    html_favicon_url = "https://github.com/next-rs/yew-alert/assets/62179149/03114e06-dcf8-4121-91c7-5ddc43300a43"
)]

//! # Yew Alert - Documentation
//!
//! Welcome to the official Yew Alert library documentation. This library
//! provides a flexible and customizable alert component for your Yew applications.
//!
//! ## Usage
//!
...
//! ```
//!
//! To integrate the library into your Yew application, you can use the `Alert` component.
...
//!
//! [examples]: https://github.com/next-rs/yew-alert/examples/tailwind
//!
//! ## Configuration
//!
//! Yew Alert allows you to customize various aspects of the alert component through the
//! `AlertProps` structure. You can adjust properties such as message content, button text,
//! styling, and more. Refer to the `AlertProps` documentation for detailed configuration options.
//!
//! ```rust,no_run
...
//! to the [GitHub repository](https://github.com/next-rs/yew-alert). We appreciate your feedback
//! and involvement in making Yew Alert better!
//!
//! ## Acknowledgments
//!
...
const POSITION: &'static str = "top-right";
...
pub fn Alert(props: &AlertProps) -> Html {
    ...
    let mut icon_color = props.icon_type;
    if props.icon_color.is_empty() {
        icon_color = match &props.icon_type.to_lowercase()[..] {
    ...
    let icon_path = match &props.icon_type.to_lowercase()[..] {
        "warning" => {
            html! {
                <svg
